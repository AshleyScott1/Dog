...
local ORE_DICT = {
  ...
  ["minecraft:deepslate_gold_ore"] = false,
  ["minecraft:diamond_ore"] = false,
  ["minecraft:deepslate_diamond_ore"] = false,
  ["minecraft:coal_ore"] = false,
  ["minecraft:deepslate_coal_ore"] = false,
  ["minecraft:lapis_ore"] = false,
  ["minecraft:deepslate_lapis_ore"] = false,
  ["minecraft:emerald_ore"] = false,
  ["minecraft:deepslate_emerald_ore"] = false,
  ["minecraft:quartz_ore"] = false,
  ["minecraft:redstone_ore"] = false,
  ["minecraft:deepslate_redstone_ore"] = false,
  ...
  ["create_deepslate_zinc_ore"] = false,

  -- Mekanism
  ["mekanism:tin_ore"] = false,
  ["mekanism:deepslate_tin_ore"] = false,
  ["mekanism:osmium_ore"] = false,
  ["mekanism:deepslate_osmium_ore"] = false,
  ["mekanism:uranium_ore"] = false,
  ["mekanism:deepslate_uranium_ore"] = false,
  ["mekanism:fluorite_ore"] = false,
  ["mekanism:deepslate_fluorite_ore"] = false,
  ["mekanism:lead_ore"] = false,
  ["mekanism:deepslate_lead_ore"] = false,

  -- Thermal
  ["thermal:apatite_ore"] = false,
  ["thermal:deepslate_apatite_ore"] = false,
  ["thermal:cinnabar_ore"] = false,
  ["thermal:deepslate_cinnabar_ore"] = false,
  ["thermal:niter_ore"] = false,
  ["thermal:deepslate_niter_ore"] = false,
  ["thermal:sulfur_ore"] = false,
  ["thermal:deepslate_sulfur_ore"] = false,
  ["thermal:tin_ore"] = false,
  ["thermal:deepslate_tin_ore"] = false,
  ["thermal:lead_ore"] = false,
  ["thermal:deepslate_lead_ore"] = false,
  ["thermal:silver_ore"] = false,
  ["thermal:deepslate_silver_ore"] = false,
  ["thermal:nickel_ore"] = false,
  ["thermal:deepslate_nickel_ore"] = false,
}
